...
static const OpenUsbHidApi hid_api_usb = {
    .init = hid_usb_init,
...
static const OpenUsbHidApi hid_api_ble = {
    .init = hid_ble_init,
...
const OpenUsbHidApi* open_usb_hid_get_interface(OpenUsbHidInterface interface) {
    if(interface == OpenUsbHidInterfaceUsb) {
        return &hid_api_usb;
    } else {
        return &hid_api_ble;
    }
